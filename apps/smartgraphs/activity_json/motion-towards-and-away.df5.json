...
Smartgraphs.activityDocs["/shared/motion-towards-and-away"] =

{
  ...
  "activity": {
    ...
    "datasets": [
      "/shared/motion-towards-and-away/dataset/walking-away-example",
      "/shared/motion-towards-and-away/dataset/walking-example-1",
      "/shared/motion-towards-and-away/dataset/walking-toward-example"
    ],
    "units": [

    ],
    "axes": [
      "/shared/motion-towards-and-away/axes/5m",
      "/shared/motion-towards-and-away/axes/15s",
      "/shared/motion-towards-and-away/axes/25s"
    ],
    "graphs": [
    ...
    "responseTemplates": [
      ...
      "/shared/motion-towards-and-away/response-template/walking-example-1",
      "/shared/motion-towards-and-away/response-template/two-walkers"
    ]
  },
  "pages": [
    {
  ...
  "axes": [
    {
      "url": "/shared/motion-towards-and-away/axes/15s",
    ...
    {
      "url": "/shared/motion-towards-and-away/axes/5m",
    ...
    {
      "url": "/shared/motion-towards-and-away/axes/25s",
      "units": "/builtins/units/seconds",
      "min": 0,
      "max": 25,
      "nSteps": 25,
  ...
  "graphs": [
    {
      "url": "/shared/motion-towards-and-away/graph/graph-to-match",
      "activity": "/shared/motion-towards-and-away",
      "name": "graph-to-match",
      "description": "Graph to match with sensor data",
      "title": "Position vs. Time",
      "xAxis": "/shared/motion-towards-and-away/axes/15s",
      "yAxis": "/shared/motion-towards-and-away/axes/5m",
      "initialDatasets": [
    ...
    {
      "url": "/shared/motion-towards-and-away/graph/graph-with-away-prediction",
      "activity": "/shared/motion-towards-and-away",
      "name": "graph-with-away-prediction",
    ...
    {
      "url": "/shared/motion-towards-and-away/graph/graph-with-toward-prediction",
      "activity": "/shared/motion-towards-and-away",
      "name": "graph-with-toward-prediction",
    ...
    {
      "url": "/shared/motion-towards-and-away/graph/prediction-away",
      "activity": "/shared/motion-towards-and-away",
      "name": "prediction-away",
    ...
    {
      "url": "/shared/motion-towards-and-away/graph/prediction-toward",
      "activity": "/shared/motion-towards-and-away",
      "name": "prediction-toward",
      "title": "Toward",
    ...
    {
      "url": "/shared/motion-towards-and-away/graph/sensor-away",
      "activity": "/shared/motion-towards-and-away",
      "name": "sensor-away",
    ...
    {
      "url": "/shared/motion-towards-and-away/graph/sensor-playing",
      "activity": "/shared/motion-towards-and-away",
      "name": "sensor-playing",
    ...
    {
      "url": "/shared/motion-towards-and-away/graph/sensor-toward",
      "activity": "/shared/motion-towards-and-away",
      "name": "sensor-toward",
      "description": "Graph with 'toward' prediction for adding 'toward' sensor data in page 4",
      "title": "Toward",
    ...
    {
      "url": "/shared/motion-towards-and-away/graph/two-walkers",
      "activity": "/shared/motion-towards-and-away",
      "name": "two-walkers",
      "description": "Graph for multiple choice question in page 6",
      "title": "Position vs. Time",
      "xAxis": "/shared/motion-towards-and-away/axes/25s",
      "yAxis": "/shared/motion-towards-and-away/axes/5m",
      "initialDatasets": [
    ...
    {
      "url": "/shared/motion-towards-and-away/graph/walking-example-1",
      "activity": "/shared/motion-towards-and-away",
      "name": "walking-example-1",
      "description": "Graph for multiple choice question in page 6",
  ...
  "datapoints": [
    {
      ...
      "y": 2,
      "guid": 100,
      "dataset": "/shared/motion-towards-and-away/dataset/walking-away-example"
    },
    {
      "x": 0.4,
      "y": 2.039,
    ...
    },
    {
      ...
      "y": 4.016,
      "guid": 1,
      "dataset": "/shared/motion-towards-and-away/dataset/walking-example-1"
    },
    {
      "x": 0.2,
      "y": 3.965,
    ...
    },
    {
      ...
      "y": 2.04,
      "guid": 201,
      "dataset": "/shared/motion-towards-and-away/dataset/walking-toward-example"
    },
    {
      "x": 0.4,
      "y": 2.006,
  ...
  "annotations": [
    ...
    },
    {
      ...
      "records": [
        {
          "url": "/shared/motion-towards-and-away/annotation/walking-first-point",
          "name": "walking-first-point",
          "activity": "/shared/motion-towards-and-away",
          "session": null,
          "point": 1
