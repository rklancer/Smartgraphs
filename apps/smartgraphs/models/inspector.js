...
/** @class
  ...
  An Inspector inspects the state of the system as needed in order to help a activity respond to the state of the system,
  ...
  input to a Command which shows a "help" ActivityStep if the data is not linear. (Remember that this indirection is
  ...
  string of arguments, which may reference the context variables set up by the author in the ActivityPage.
